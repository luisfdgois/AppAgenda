...
class AnnotationEdit extends StatefulWidget {
  const AnnotationEdit({Key? key}) : super(key: key);

  @override
  _AnnotationEditState createState() => _AnnotationEditState();
}

class _AnnotationEditState extends State<AnnotationEdit> {
  ...
  Widget build(BuildContext context) {
    final annotation = ModalRoute.of(context)!.settings.arguments as Annotation;

    _chosenCategory = annotation.Category;
    _selectedDate = annotation.Date;
    _selectedTime = TimeOfDay.fromDateTime(annotation.Date);

    return Scaffold(
        appBar: AppBar(
            title: Text("Edit Annotation", textAlign: TextAlign.center),
                                ...
                                child: ElevatedButton.icon(
                                    onPressed: () {
                                      ...
                                      Provider.of<AnnotationRepository>(context,
                                          listen: false)
                                          .update(annotation.Id!, Annotation(
                                          0,
